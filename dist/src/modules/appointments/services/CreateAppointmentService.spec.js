...
describe('CreateAppointment', function () {
    ...
    it('should not be able to create a two appointments on the same time', function () { return __awaiter(void 0, void 0, void 0, function () {
        var appointmentDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('should not be able to create an appointment on past date', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
    ...
    it('should not be able to create an appointment with same user provider', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
